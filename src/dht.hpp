...
class DHT {
  ...
  public:
     ...
     *
     * @return returns a int whether the reading was succesful. 1 = succeeded. 0 = timed out
     */
    int dhtRead();
     ...
     * a function that starts the read protocol for the dht sensor.
     *
     * @return returns a int whether the checksum() was succesful. 1 = succeeded. 0 = timed out
     */
    int dhtReadGetBits();
     ...
     *
     * @return returns a int whether the start was obtained. 1 = succeeded. 0 = timed out
     */
    int dhtReadWait();
};
